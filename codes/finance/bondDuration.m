...
h = figure(1);
hold on
plot(datetime(time_vec,'convertfrom','datenum'),dur_vec,'linewidth',2)
xlabel('maturity')
ylabel('duration')
xtickformat('yyyy')
figure(1)
...
saveTightFigure(h,'bondDurationVsYieldVsMaturity.pdf')
...
saveTightFigure(h,'bondDurationVsYieldVsCoupon.pdf')
